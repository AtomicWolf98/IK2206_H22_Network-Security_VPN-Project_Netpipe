...
public class SessionCipher {
     ...
     */
    public SessionCipher(SessionKey key, byte[] sessionIVBytes, int i) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidParameterSpecException, InvalidKeyException, InvalidAlgorithmParameterException {
     ...
     */
    static CipherOutputStream openEncryptedOutputStream(OutputStream os) {
    ...
    static CipherInputStream openDecryptedInputStream(InputStream inputstream) {
