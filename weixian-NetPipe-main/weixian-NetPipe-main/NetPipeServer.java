...
public class NetPipeServer {
    ...
    public void ClientHelloVerify (Socket socket, String cacert) throws Exception {
    ...
    public static void main( String[] args) {
        ...
        try{
             ...
             * arguments input
             */
            String Clientcert = arguments.get("usercert");
            String Servercert = arguments.get("cacert");
